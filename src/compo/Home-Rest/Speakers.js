          ...
          <div className="card">
            <div className="card-thumb">
              ...
              <span className="client-name">
                ...
                <br />
                (Evan Pugh Professor of Physics, holder of the Eberly Chair in
                Physics, the Founding Director Emeritus of the Institute for
                Gravitation and the Cosmos, Penn State)
              </span>
            </div>
            <div className="card-body">
              <div className="time">
